...
public class ModBlocks {
    ...
    public static final RegistryObject<Block, Block> ENERGY_CORE = registerBlock("energy_core",
            () -> new Block(blockBuilder("energy_core").destroyTime(3.0f)));

    public static final RegistryObject<Block, Block> ANCHOR_CONTROLLER = registerBlock("anchor_controller",
            () -> new Block(blockBuilder("anchor_controller").destroyTime(3.0f)));
    ...
    private static RegistryObject<Block, Block> registerBlock(String name, Supplier<Block> blockSupplier) {
        RegistryObject<Block, Block> block = BLOCKS.register(name, blockSupplier);
